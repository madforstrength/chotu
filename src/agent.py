...
""")
    ...
    while True:
        ...
        system_prompt = (
            ...
            "You are an agent that can run any valid kubectl command (for Kubernetes), call any of the following GitHub MCP tools, or answer questions directly.\n"
            "To run a Kubernetes command, set 'action' to 'run_kubectl' and provide the full kubectl command in the 'command' field.\n"
            "Examples of valid kubectl commands: 'kubectl get pods', 'kubectl describe deployment my-app', 'kubectl apply -f manifest.yaml', etc.\n"
